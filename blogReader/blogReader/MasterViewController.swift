 ...
 */
        ...
        let url = URL(string: "https://www.googleapis.com/blogger/v3/blogs/10861780/posts?key=AIzaSyA64KcTIQckglyfwDDun8c0LBVxVruQLec")!
                    ...
                    do {
                       ...
                       // print(jsonResult)
                        if let items = jsonResult["items"] as? NSArray {
                            ...
                            //process in main queue
                            DispatchQueue.main.async(execute: {
                                // MARK: - TABLE INPUT IN HERE
                        ...
                        print("Json is not available or Json processes failed!")
                    }
                }
            }
        }
